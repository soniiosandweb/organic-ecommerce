...
export const LIMIT_CATEGORY_REQUEST = "LIMIT_CATEGORY_REQUEST";
export const LIMIT_CATEGORY_SUCCESS = "LIMIT_CATEGORY_SUCCESS";
export const LIMIT_CATEGORY_FAIL = "LIMIT_CATEGORY_FAIL";

export const REMOVE_CATEGORY_DETAILS = "REMOVE_CATEGORY_DETAILS";
