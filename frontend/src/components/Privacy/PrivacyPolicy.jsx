            ...
            <main className="w-full sm:mt-0">
                ...
                <div className="py-8 lg:py-16 sm:w-11/12 m-auto px-4 w-full relative z-10 text-md">
                    ...
                    <div className="pt-10 w-full">
                        ...
                        <p className='pt-3'><b>Personal Information:</b> This includes your name, email address, phone number, shipping address, billing address, and payment information.</p>
                        <p className='pt-3'><b>Account Information:</b> When you create an account, we collect your username, password, and other registration details.</p>
                        <p className='pt-3'><b>Transaction Information:</b> Details about your purchases, order history, and payment methods.</p>
                        <p className='pt-3'><b>Usage Information:</b> Information about how you use our website, including your IP address, browser type, device information, pages visited, and actions taken.</p>
                        <p className='pt-3'><b>Cookies and Tracking Technologies:</b> We use cookies and similar technologies to track your activity on our website and collect certain information.</p>
                    </div>
                    ...
                    <div className="pt-10 w-full">
                        ...
                        <p className='pt-3'><b>Service Providers:</b> Third-party vendors that help us operate our website, process payments, and fulfill orders.</p>
                        <p className='pt-3'><b>Business Partners:</b> Partners with whom we may collaborate for special offers or joint promotions.</p>
                        <p className='pt-3'><b>Legal Requirements:</b> If required by law or in response to legal processes, we may disclose your information to law enforcement or regulatory authorities.</p>
                    </div>
