                ...
                <div className="flex py-10 justify-between ">
                    ...
                    <div className='w-1/4 flex-1'>
                        <div className='trending-banner h-full w-full relative'>
                            <div className='trending-text h-full w-full flex items-center flex-col z-10 relative p-10'>
                                <h3 className='text-3xl font-semibold text-center mb-5'>Deal Of The Day 25% off</h3>
